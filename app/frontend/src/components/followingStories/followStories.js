  ...
  render() {
    return (
      <Fragment>
        <div class="container">
          <h2>Hello, user!</h2>
          <div class="[ col-xs-12 col-sm-offset-1 col-sm-5 ] wrapper">
            <div class="[ panel panel-default ] panel-google-plus">
              ...
              <div class="panel-body">
                <p>
                  Do people born in 2000 get to choose if they are Generation Y
                  or Generation Z? How do you decide what generation you want to
                  belong to?
                </p>
              </div>
