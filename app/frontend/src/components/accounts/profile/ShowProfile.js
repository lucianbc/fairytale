        ...
        return (
            <div className="container" style={{ paddingTop: "5%" }}>
                                ...
                                <div className="card-title mb-4">
                                    <div className="d-flex justify-content-start">
                                        <div className="image-container">
                                            <img src={avatar || defaultAvatar} id="imgProfile" style={{ width: "150px", height: "150px" }} className="img-thumbnail" />
                                        </div>
                ...
                <div style={{ paddingTop: "2%" }}>
                    <button className="btn btn-primary" onClick={this.onClick}>Edit Profile</button>
                </div>
            </div >
        )
    }
